    ...
    <div className="users">
      <div className="users_header">
        ...
        <div className="users_actions">
          ...
          <button className="add_user_btn" onClick={() => setShowCreateForm(true)}>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td><span className="role_style">Admin</span></td>
              <td><span className="status_style active">Active</span></td>
            ...
            <tr>
              ...
              <td><span className="role_style">Student</span></td>
              <td><span className="status_style inactive">Inactive</span></td>
              <td className="actions">
                <button className="edit_btn"><FaUserEdit /></button>
                <button className="delete_btn"><FaTrash /></button>
              </td>
